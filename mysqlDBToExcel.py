...
workbook = xlsxwriter.Workbook('attackv8.xlsx')
...
cell_format_score_0 = workbook.add_format({'bold': True, 'font_color': 'black', 'bg_color': '#D84D24', 'border': 1})
cell_format_score_1 = workbook.add_format({'bold': True, 'font_color': 'black', 'bg_color': '#EDF456', 'border': 1})
cell_format_score_2 = workbook.add_format({'bold': True, 'font_color': 'black', 'bg_color': '#85D589', 'border': 1})
cell_format_score_3 = workbook.add_format({'bold': True, 'font_color': 'black', 'bg_color': '#F3F5B0', 'border': 1})
...
'''
for i in range(0,tacl):
     print(tacrow[i])
     for j in range(0,rowl):
             if tacrow[i][0] == rows[j][2]:
                     print(rows[j][1])
                     print("-"*120)
